...
func TestGetMe_Success(t *testing.T) {
	...
	RegisterUserRoutes(r.Group("/api/v1/users"), nil, mockStore, nil, nil, nil, nil, nil, nil)
...
func TestGetMe_Unauthorized(t *testing.T) {
	...
	RegisterUserRoutes(r.Group("/api/v1/users"), nil, &MockUserStore{}, nil, nil, nil, nil, nil, nil)
