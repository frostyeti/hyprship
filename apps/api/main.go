...
func main() {
	...
	v1.RegisterRoutes(apiV1, identitySvc, storeFactory.UserStore, storeFactory.RoleStore, storeFactory.GroupStore, storeFactory.ProjectStore, storeFactory.EnvironmentStore, storeFactory.ConfigStore, storeFactory.SecretStore, storeFactory.UserSessionStore, apiKeySvc, passkeySvc, mfaSvc, verificationSvc, importExportSvc)
