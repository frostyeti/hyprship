...
func main() {
	...
	v1.RegisterRoutes(apiV1, identitySvc, storeFactory.UserStore, storeFactory.RoleStore, storeFactory.GroupStore, storeFactory.UserSessionStore, apiKeySvc, passkeySvc, mfaSvc, verificationSvc, importExportSvc)
